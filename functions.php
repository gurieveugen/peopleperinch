...
include( TEMPLATEPATH.'/admin-add-new.php' );
include( TEMPLATEPATH.'/admin-create-artwork.php' );
include( TEMPLATEPATH.'/admin-pixel-summary.php' );
include( TEMPLATEPATH.'/admin-review-artwork.php' );
